...
Call log:
  - waiting for locator('//a[text()=\'${productName}\']')
    ...
    - list [ref=e6]:
      ...
      - listitem [ref=e16]:
        - link "Log out" [ref=e17] [cursor=pointer]:
          - /url: "#"
      - listitem [ref=e18]:
        - link "Welcome shilpik" [ref=e19] [cursor=pointer]:
          - /url: "#"
      - listitem
    - generic [ref=e21]:
      - list [ref=e22]:
...
```ts
  ...
  4  |     {
  5  |         this.page=page;
  6  |         this.product=page.locator("//a[text()='${productName}']");
  7  |     
  8  |     }
  9  |     async selectProduct(productName)
  10 |     {
> 11 |         await this.product.click();
     |                            ^ Error: locator.click: Test timeout of 30000ms exceeded.
  12 |     }
  13 | }
```