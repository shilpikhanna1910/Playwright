...
```ts
  ...
  4  |     {
  5  |         this.page=page;
  6  |         this.scroll=page.mouse.wheel(0,500);
  7  |         this.product=page.locator("//a[text()='${productName}']");
  8  |     
  9  |     }
  10 |     async selectProduct(productName)
  11 |     {
  12 |         await this.scroll;
> 13 |         await this.product.click();
     |                            ^ Error: locator.click: Test timeout of 30000ms exceeded.
  14 |     }
  15 | }
```