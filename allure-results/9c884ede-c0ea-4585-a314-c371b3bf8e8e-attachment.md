...
- Name: Groupings.spec.js >> Parallel Execution >> Test2
...
```ts
  ...
  2  | //test.describe.serial('Serial Execution',async()=>{//one at a time and in one order.not go ahaead if one test is failing
